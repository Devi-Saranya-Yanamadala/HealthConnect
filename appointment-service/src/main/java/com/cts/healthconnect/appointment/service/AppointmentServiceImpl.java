...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public AppointmentResponseDto completeAppointmentByCode(String appointmentCode) {
        ...
        notify("APPOINTMENT", appointment.getPatientId(), patientEmail,
               "Your appointment " + appointmentCode + " has been completed. Thank you!");
 
        audit("COMPLETE_APPOINTMENT", appointmentCode, "Appointment completed");
 
        return mapToResponse(appointment);
    }
    @Override
    public List<AppointmentResponseDto> getAppointmentsByDoctorCode(String doctorCode) {
        return repository.findByDoctorCodeOrderByAppointmentDateDesc(doctorCode)
                .stream()
                .map(this::mapToResponse)
                .toList();
    }
